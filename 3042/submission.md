...
```text
ให้รับค่าจำนวนเต็ม สดงจำนวนเต็มบวกตั้งแต่ N ถึง 0 ที่หารด้วย 10 ลงตัว
```
...
```text
รับค่าจำนวนเต็ม แล้วสร้างfor loop ให้เริ่มนับจากค่าที่รับเข้ามา ให้นับไปจนถึงก่อนตัวเลขนี้ ซึ่งก็คือจะหยุดทำงานเมื่อถึง 0 พอดี ให้ลดค่าลงทีละ 1
```
