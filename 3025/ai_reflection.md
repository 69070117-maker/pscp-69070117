...
| OJ submission ID, if submitted | 560346 |
| OJ status | Pass |
...
```text
สร้างเงื่อนไขแต่ละเดือนไปเรื่อยๆ จน ครบ
```
...
```text
มีบางเงื่อนไข ที่ยังสับสน เลยลองแก้ๆๆๆ จนผ่าน
```
...
```text
การใช้ +=  
การแยกเงื่อนไข เป็นหัวข้อใหญ่ขึ้น
การย่อรูปเงื่อนไข เช่น 0 < month <= 3
```
