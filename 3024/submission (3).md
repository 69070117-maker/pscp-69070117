...
```text
รับค่า คะแนน รวมของสามคน คะแนนสูงสุด 
แสดงผล"Surprising" หรือ "Not surprising"
```
...
```text
หาค่าเฉลี่ย ของสองคนที่เหลือ แล้วเอามาลบกับ คะแนนสูงสุด
```
...
```text
ใช้ หาค่าน้อยสุดจาก maxเพื่อหาค่ามากสุด จาก 0 และ คะแนนรวมของอีก 2 คนที่เหลือ จะเท่ากับ total - max_val เพราะลบคะแนนของคนที่เปนmaxออก และลบ คะแนนมากสุดออกอีกครั้งเพื่อหาคะแนนน้อยสุดเท่าที่เป็นไปได้
```
...
```text
ลองใช้max เพื่อหา ค่าน้อยสุดที่เปนไปได้
```

คุณยังทำอะไรด้วยตนเอง

```text
 วางแนวคิดใหม่และเขียนโค้ดต่อ
```
