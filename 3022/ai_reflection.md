...
| OJ submission ID, if submitted | 554464 |
| OJ status | Pass |
...
```text
ให้ช่วยดูแlogicของโค้ดversionแรก และให้ช่วยแนะนำว่า ทำยังไงให้ใช้ if elif ให้น้อยลง 
...
```text
แบ่งโค้ด เป็นสองsession ให้เปลี่ยนคหน่วยเป็นcelsuis แล้วค่อยหาคำตอบ 
```
