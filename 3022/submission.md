...
```text
ให้รับค่า 3 บรรทัด บรรทัดที่1 เป็นค่าอุณหภูมิ
บรรทัดที่2เป็น หน่วยอุณหภูมิของค่าที่รับเข้ามา 
บรรทัดที่3เป็นค่าที่ต้องการแปลง  
แสดงผล เป็นอุณหภูมิ ตามหน่วยในบรรทัดที่ 3 ใน Input Spec ให้ตอบทศนิยม 2 ตำแหน่ง
```
...
```text
แปลงเป็นcelsuis แล้วเปลี่ยนเป็นหน่วยปลายทาง
```
...
```text
รับค่าอุณหภูมิ แล้วแปลงเป็น เซลเซียส แล้วแปลงจากเซลเซียสเป็นอุณหภูมิในหน่วยต่างๆ ตามสูตร
```
...
```text
เรียบเรียงและเขียนโค้ด คิดเทสเคส
```
