...
```text
รับค่าสามจำนวน บรรทัดเดียว แสดงผลคนที่เปนขโมย
```
...
```text
รับค่า n k t แล้วเช็คว่าถ้าขโมยคือคนแรก ถ้าคนแรกเปนขโมย t=1 ให้พิมพ์ 1 แล้วจบ ถ้าไม่ใช่ ก็ตั้งตำแหน่งปัจจุบันเริ่มที่คนแรกและเซ็ตนับคนไว้ที่ 1 แล้วก้ while loop วนหาคนถัดไปเรื่อยๆ ถ้าเจอคนแรกให้หยุดทำ แต่ถ้าเจอขโมยให้บวกนับเพิ่มอีก 1 แล้วหยุดทำ หากยังไม่เจอใครให้บวกนับเพิ่ม 1 เปลี่ยนตำแหน่งเป็นคนถัดไปแล้ววนทำรอบต่อไป พอหลุดลูปค่อยปริ้นจำนวนคนทั้งหมดออกมา
```
