...
```text
แสดงผลคะแนนรวม โดย มีอินพุตเป็นเเลข และรับค่าตามเลขที่กรอกตอนแรก หากเป็นเครื่องหมาย+ =+10   , - =-5
```
...
```text
รับค่าเป็นเลขจำนวนรับค่าอินพุต สร้างตัวแปลขึ้นมาเก็บค่า + - แล้วเช็คว่าถ้า+อยู่ในตัวแปรนั้น ให้นับจำนวนว่ามีกี่ตัวแล้วคุณด้วย10 และ - ก็ทำเหมือนกัน ถ้าเป็ยอย่างอื่นให้ = 0 แล้วนำ ค่าของ + - มา + กัน
```
