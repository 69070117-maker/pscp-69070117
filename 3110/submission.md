...
```text
รับค่าสมาชิก ถ้าเป็นให้ลด 5% ถ้าไม่เป็นแต่ยอดรวมเกิน500 ให้ลด3% แล้วแสดงค่าทศนิยมสองตำแหน่ง
...
```text
คล้ายข้อ3 แต่from decimal import Decimal, ROUND_HALF_UP เพื่อให้ทศนิยมไม่คลาดเคลื่อน และปัดเศษ5ขึ้น
```
